...
def test_get_data() -> None:
    expected_data = pd.DataFrame({
        0: ['https://www.example.com/', 'https://www.test.com/', 'https://www.demo.com/', 'https://www.sample.com/', 'https://www.data.com/'], 
        1: ["2023-05-18", "2023-05-19", "2023-05-20", "2023-05-21", "2023-05-22"],
        2: ["Привет, это контент 1.", "Здесь находится контент 2.", "Это третий контент для примера.", "Вот еще один контент для теста.", "Последний контент в этом наборе данных."]
    })
